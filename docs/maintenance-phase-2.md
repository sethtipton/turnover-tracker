...
- IMPORTANT: Gmail classified this first branded email as Spam. It displayed the expected mailed-by and signed-by domains and TLS. Provider delivery is proven; reliable inbox placement is not. Seth confirmed marking the legitimate pilot message “Report not spam.” A subsequent delivery still needs testing before relying on email alone. The app inbox remains the authoritative request record.
